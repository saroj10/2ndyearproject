...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.php">Garbage Management System</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <!--<li><a class="nav-link scrollto" href="adminlogin/payment.php"><span class="fa fa-credit-card"> Payment</span></a></li>-->
          <li><a class="nav-link scrollto" href="phpGmailSMTP/trash.php"><span class="fa fa-trash">  Create Complain</span></a></li>
          <li><a class="nav-link scrollto" href="adminlogin/welcome.php"><span class="fa fa-edit"> Preview Complain </span></a></li>
          <li><a class="nav-link scrollto" href="phpGmailSMTP/contact.php"><span class="fa fa-envelope" aria-hidden="true"> Contact</span></a></li>
    ...
    <section id="cliens" class="cliens section-bg">
      <div class="container">
        ...
        <div class="row" data-aos="zoom-in">
          ...
          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="assets/img/clients/img1.jpg" class="img-fluid" alt="">
          </div> 
 ...
 of complaining the concerns of general citizens to their relative municipalities. 
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            <p>
              Complaining about the garbage problem encountered everyday to municipality is hefty process and garbage management
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="row">
          <div class="col-lg-9 text-center text-lg-start">
            ...
            <p> Here is the phone number.</p>
          </div>
          <div class="col-lg-3 cta-btn-container text-center">
            <a class="cta-btn align-middle" href="tel:+977 9874474832">Call To Action</a>
          </div>
        </div>
    ...
    <section id="faq" class="faq section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Garbage management regulations and disposal methods.</p>
        </div>

        <div class="faq-list">
          <ul>
            <li data-aos="fade-up" data-aos-delay="100">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1"> What is garbage management? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                <p>
                  Garbage management is the collection, transportation and disposal of waste materials.                </p>
              </div>
            </li>

            <li data-aos="fade-up" data-aos-delay="200">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-2" class="collapsed">   How do I practice garbage management at home? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="300">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-3" class="collapsed"> What are the first few steps to initiate a garbage management programme in your apartment complex?
            ...
            <li data-aos="fade-up" data-aos-delay="400">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-4" class="collapsed">What are the different types of garbage? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="500">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-5" class="collapsed">What are ways of storing the garbage at homes? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="600">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-6" class="collapsed">How do I dispose my garbage? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-5" class="collapse" data-bs-parent=".faq-list">
                <p>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <p>Follow us in our social media to stay updated about community Garbage management.</p>
    ...
    <div class="container footer-bottom clearfix">
      ...
      <div class="credits">
       Designed by <a href="">Pranish Dangol </a> and <a href="">Saroj Bhatta </a>
      </div>
    </div>
  </footer><!-- End Footer -->
